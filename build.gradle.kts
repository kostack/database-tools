...
mavenPublishing {
  ...
  pom {
    ...
    url.set("https://github.com/kostack/database-tools")
    ...
    scm {
      connection.set("scm:git:git://github.com/kostack/database-tools.git")
      developerConnection.set("scm:git:ssh://github.com/kostack/database-tools.git")
      url.set("https://github.com/kostack/database-tools")
    }
  }
}
